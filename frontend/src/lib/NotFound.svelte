...
<HeaderElement>
  <ResourceToolbar slot="toolbar" />
</HeaderElement>

<div
  class="router-page not-found flex h-full items-center justify-center space-x-8 space-y-16 lg:flex-row lg:space-y-0 2xl:space-x-0"
...
>
  ...
  >
    <p
      class="text-7xl font-bold tracking-wider text-gray-400 drop-shadow-md md:text-8xl lg:text-9xl"
    >
      404
    </p>
    <p
      class="mt-2 text-4xl font-bold tracking-wider text-gray-400 drop-shadow-sm md:text-5xl lg:text-6xl"
    >
      Page Not Found
    </p>
    ...
    <a
      role="button"
      class="btn btn-ghost flex bg-base-200 transition duration-150 hover:bg-primary hover:drop-shadow-md"
      href="/"
      use:link
    >
      <svg
  ...
  >
    ...
    >
      ...
      <circle cx="212.59226" cy="103" r="64" fill="hsl(var(--b2))" />
      <path
      ...
      <ellipse
        ...
        fill="hsl(var(--b2))"
      />
      <circle cx="97.08375" cy="566.26982" r="79" fill={gray400} />
      <rect
        x="99.80546"
        y="689.02332"
        width="24"
      ...
      <ellipse
        ...
        fill={gray400}
      />
      <circle cx="99.31925" cy="546.29477" r="27" fill="#ffffff" />
      <circle cx="99.31925" cy="546.29477" r="9" fill={gray400} />
      <path
      ...
      <path
        ...
        fill="hsl(var(--b3))"
      />
      <circle cx="712.48505" cy="565.41532" r="79" fill={gray400} />
      <rect
        x="741.77716"
        y="691.82355"
        width="24"
      ...
      <ellipse
        ...
        rx="20"
        ry="7.5"
        transform="translate(-234.8 193.8) rotate(-16.9)"
        fill={gray400}
      />
      <ellipse
        cx="813.47537"
        ...
        fill={gray400}
      />
      <circle cx="708.52153" cy="545.71023" r="27" fill="#ffffff" />
      <circle cx="708.52153" cy="545.71023" r="9" fill={gray400} />
      <path
