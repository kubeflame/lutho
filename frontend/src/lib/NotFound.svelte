...
<RouterPage error={""} loading={false}>
  <ResourceToolbar slot="resource-toolbar" />
  <div
    class="not-found flex h-full items-center justify-center space-x-8 space-y-16 lg:flex-row lg:space-y-0 2xl:space-x-0"
  >
    <div
    ...
    >
      ...
      >
        ...
        <circle cx="212.59226" cy="103" r="64" fill="oklch(var(--b2))" />
        <path
